...
states_and_transitions = [
    ...
    ["initial_intrusion", ["initial_intrusion", "discovery", "privilege_escalation", "exit"]],
    ["discovery", ["discovery", "privilege_escalation", "data_exfiltration", "exit"]],
    ["privilege_escalation", ["privilege_escalation", "discovery", "persistence", "exit"]],
    ["persistence", ["persistence", "discovery", "privilege_escalation", "persistence", "exit"]],
    ["data_exfiltration", ["data_exfiltration", "discovery", "privilege_escalation", "persistence", "exit"]]
    ]
print("Done.")
sys.stdout.flush()
sleep(STALL_TIME) #stalling
